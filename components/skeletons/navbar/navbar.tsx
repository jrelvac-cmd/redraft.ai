...
export default function Navbar({
  logo = {
    url: "https://recreate.ai",
    src: "https://api.dicebear.com/7.x/initials/svg?seed=RA&backgroundColor=2563eb&textColor=ffffff",
    alt: "Recreate.AI logo",
    title: "Recreate.AI",
  },
  ...
  menu = [
    ...
    },
    {
      ...
      items: [
        ...
        {
          title: "Tutorials",
          description: "Step-by-step guides to learn Recreate.AI quickly",
